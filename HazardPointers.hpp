//
// Created by rohit on 2/1/2019.
//
#ifndef THREADS_EXP_HAZARDPOINTERS_HPP
#define THREADS_EXP_HAZARDPOINTERS_HPP
...
public:
    HazardPointers(fixed_managed_shared_memory *shm, int maxHPs = HP_MAX_HPS, int maxThreads = HP_MAX_THREADS) : shm(
            shm), maxHPs{maxHPs}, maxThreads{maxThreads} {
...
#endif //THREADS_EXP_HAZARDPOINTERS_HPP
